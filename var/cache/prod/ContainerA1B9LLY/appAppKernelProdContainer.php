...
class appAppKernelProdContainer extends Container
{
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('6RAKpsuOsJ', 0, ($this->targetDir.''.'/pools'), new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL));
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = (new \Doctrine\Bundle\DoctrineBundle\ConnectionFactory([]))->createConnection(['driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => '8889', 'dbname' => 'TJM_prestashop', 'user' => 'root', 'password' => 'root', 'charset' => 'utf8mb4', 'driverOptions' => [1002 => 'SET sql_mode=(SELECT REPLACE(@@sql_mode,\'ONLY_FULL_GROUP_BY\',\'\'))', 1013 => $this->getEnv('const:runtime:_PS_ALLOW_MULTI_STATEMENTS_QUERIES_')], 'defaultTableOptions' => []], new \Doctrine\DBAL\Configuration(), $a, ['enum' => 'string']);
    }
    ...
    {
        return $this->privates['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('4orwKnUPnt', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['fragment.listener'] = new \Symfony\Component\HttpKernel\EventListener\FragmentListener(($this->privates['uri_signer'] ?? ($this->privates['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('0fIuRrqhFgCcMjhVNk0P1F40gf0tpYdNOof6Cm6aUYXVIjqS7C6ziTMNBBsbyosw'))), '/_fragment');
    }
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'modules_translation_paths' => [
                ...
                24 => (\dirname(__DIR__, 4).'/modules/statspersonalinfos/translations'),
                25 => (\dirname(__DIR__, 4).'/modules/statsdata/translations'),
                ...
                36 => (\dirname(__DIR__, 4).'/modules/ps_themecusto/translations'),
                ...
                45 => (\dirname(__DIR__, 4).'/modules/ps_categoryproducts/translations'),
                46 => (\dirname(__DIR__, 4).'/modules/ps_emailalerts/translations'),
                47 => (\dirname(__DIR__, 4).'/modules/statscheckup/translations'),
                48 => (\dirname(__DIR__, 4).'/modules/dashactivity/translations'),
                49 => (\dirname(__DIR__, 4).'/modules/ps_supplierlist/translations'),
                ...
                55 => (\dirname(__DIR__, 4).'/modules/gsitemap/translations'),
                56 => (\dirname(__DIR__, 4).'/modules/statsstock/translations'),
                57 => (\dirname(__DIR__, 4).'/modules/paypal/translations'),
            ],
            ...
            'kernel.secret' => '0fIuRrqhFgCcMjhVNk0P1F40gf0tpYdNOof6Cm6aUYXVIjqS7C6ziTMNBBsbyosw',
